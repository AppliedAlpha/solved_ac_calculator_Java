...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            JSONObject j = XML.toJSONObject("<![CDATA[This is a collection of test patterns and examples for ]]>  Ignore the stuff past the end.  ");
            ...
            System.out.println();
            JSONArray a = JSONML.toJSONArray(s);
            ...
            j.put("int", 57);
            j.put("double", 1.2345678901234568E29D);
            j.put("true", true);
            j.put("false", false);
            ...
            try {
                System.out.println(j.put((String)null, "howard"));
            ...
            try {
                System.out.println(a.put(0.0D / 0.0));
            ...
            System.out.println(var31.toString());
        }
